  ...
  return (
    <div className=" border-red-700">
        <div className=" border-orange-900">
            <div className=" border-green-700 grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
